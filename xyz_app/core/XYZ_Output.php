 ...
 */
class XYZ_Output extends CI_Output {
	...
	/**
	 * Set the  template that should be contain the output <br /><em><b>Note:</b> This method set the output mode to XYZ_Output::OUTPUT_MODE_TEMPLATE</em>
	 *
	 * @uses XYZ_Output::set_mode()
	...
	/**
	 * Sets the way that the final output should be handled.<p>Accepts two possible values 	XYZ_Output::OUTPUT_MODE_NORMAL for direct output
	 * or XYZ_Output::OUTPUT_MODE_TEMPLATE for displaying the output contained in the specified template.</p>
	 *
	 * @throws Exception when the given mode hasn't defined.
	 * @param integer $mode one of the constants XYZ_Output::OUTPUT_MODE_NORMAL or XYZ_Output::OUTPUT_MODE_TEMPLATE
	 * @return void
	 */
	...
	/**
	 * Set the title of a page, it works only with XYZ_Output::OUTPUT_MODE_TEMPLATE
	 *
	 *
	 * @param string $title
	 * @return void
